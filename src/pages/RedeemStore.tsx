        ...
        {tab === "store" && (
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            ...
            {rewards.map((reward, i) => (
              ...
              >
                {reward.image_url && (
                  <img src={supabaseImg(reward.image_url, 500)} alt={reward.name} loading="lazy" decoding="async" className="mb-3 h-40 w-full rounded-lg object-contain bg-secondary/40" />
                )}
