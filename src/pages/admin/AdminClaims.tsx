                  ...
                  <tr key={claim.id} className="border-b border-border/50 hover:bg-muted/20 transition-colors">
                    <td className="px-4 py-3">
                      <div className="flex items-center gap-3">
                        {claim.image_url ? (
                          <img src={claim.image_url} alt="" className="h-10 w-10 rounded-lg object-contain bg-secondary/40 p-1" />
                        ) : (
          ...
          <div className="w-full max-w-lg max-h-[85vh] overflow-y-auto rounded-2xl border border-border bg-card">
            ...
            <div className="p-5 space-y-4">
              ...
              <div className="flex items-center gap-3 rounded-xl bg-muted/30 p-3">
                {selectedClaim.image_url && <img src={selectedClaim.image_url} alt="" className="h-14 w-14 rounded-lg object-contain bg-secondary/40 p-1" />}
                <div>
