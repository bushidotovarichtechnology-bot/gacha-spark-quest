-- Kosongkan Hall of Fame: hapus semua draws Grand Prize (tier S)
DELETE FROM public.draws WHERE tier_label = 'S';

-- Pastikan fungsi pemenang Hall of Fame mengecualikan admin (idempotent)
